...
if( $values != "" ) {
    ...
    foreach( $res as $row ) {		
		$data_array = array(				
							...
							"link" 			=> stripslashes( 'http://english.liveindia.live/postdetail/index/id/' . $row['post_id'] ),
							"total_num_comment" 	=> $row['comment_count'],
							"created"		=> strtotime( $row['created'] ),
							"large_image" 		=> array( "http://english.liveindia.live/public/products/image/" .$row['thumb_image'] )			
			);
